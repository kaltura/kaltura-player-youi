...
extern "C" {
    JNIEXPORT void JNICALL Java_tv_youi_kalturaplayeryoui_PKDownloadWrapper_nativeSendEvent(JNIEnv *, jclass, jobject, jstring, jstring);
}
...
void JNICALL Java_tv_youi_kalturaplayeryoui_PKDownloadWrapper_nativeSendEvent(JNIEnv *pEnv, jclass cls, jobject instance, jstring name, jstring payload)
{
...
{
     jclass tmpBridgeClass = GetEnv()->FindClass("tv/youi/kalturaplayeryoui/PKDownloadWrapper");
